...
export default function SignIn(props) {
  ...
  return (
    // <div>
    <div className="login-ppage" style={{ display: "block" }}>
      <div className="lcolumns w-row">
        <ParnerDetail component={true} />

        <div className="lcolumn-3 w-col w-col-8">
          <div>
            <img
              src="/images/ioAudio-logo_transparent-1.png"
              loading="lazy"
              sizes="183.99305725097656px"
          ...
          {!forgetScreen ? (
            <div className="llogin-div-copy">
              <div id="login-form" className="login-form w-form">
                <div className="welcome-back-ioaudio-login">
                  <strong className="create-ioaudio">
                    Welcome Back!
                    <br />
                ...
                >
                  ...
                  <Button
                    ...
                    className="login-submmit w-button"
                  >
                    Login{" "}
                  </Button>
                  ...
                  <p
                    ...
                    id="login-submit"
                    className="login-facebook w-button"
                  >
                    {" "}
                    Login with Facebook{" "}
                  </p>
                  <p
                    ...
                    className="login-google w-button"
                  >
                    Login with Google
                  </p>

                  <p className="need-on-login">New to ioAudio? </p>
                  <p
                    onClick={handleToLogin}
                    data-w-id="d0b9e9d7-453f-9fff-63a8-2a1c2da75ca5"
            ...
            <div className="forget-password-div" style={{ display: "flex" }}>
              {!showResetScreen ? (
                <div className="forget-password-form w-form">
                  ...
                  >
                    ...
                    <p className="create-free-account-on-login">
                      Create free ioAudio Account
                    </p>
                  </form>
                </div>
                  ...
                  <div id="conf-code-form" className="conf-code-form w-form">
                    ...
                    >
                      ...
                      <Button
                        ...
                        loading={formData.loading}
                        class="send-reset-email w-button"
                      >
                        Verifry and Reset
                      </Button>
